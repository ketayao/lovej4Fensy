				...
				<div class="love-article-content">
					<p>
						&nbsp; &nbsp; <span style="font-size: 12px;">&nbsp;
							&nbsp;&nbsp;</span><span style="font-size: 12px;">loveJ是一个完全开源的、简单的个人博客，可以用来发布内容，图片，链接，附件，留言等功能。当前版本0.0.1-BETA。</span>
					</p>
					<p>
						<span style="font-size: 12px;">fensy版本0.0.1-BETA，lucene-search版本0.0.1-SNAPSHOT。</span>
					</p>
					<p>
