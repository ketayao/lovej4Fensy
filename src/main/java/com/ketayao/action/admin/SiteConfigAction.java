...
public class SiteConfigAction {
    ...
    public String u(WebContext rc) throws IllegalAccessException, InvocationTargetException {
        ...
        siteConfig.updateAttrs(
            new String[] { "about", "url", "contactDescription", "icp", "name" }, new Object[] {
                    siteConfig.getAbout(), siteConfig.getUrl(), siteConfig.getContactDescription(),
